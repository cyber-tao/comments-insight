...
export const CONFIG_GENERATION_PROGRESS = {
  ANALYZING: 30,
  GENERATING: 50,
  SAVING: 80,
  STEPS: {
...
export const DOM = {
  ...
  DETECT_MIN_DEPTH: 10,
  DETECT_SHALLOW_DEPTH_RATIO: 0.5,
  INDENT: '  ',
};
...
export const LIMITS = {
  ...
  AI_LOG_MAX_FIELD_LENGTH: 12000,
  AI_LOG_TOTAL_CHAR_BUDGET: 200000,
